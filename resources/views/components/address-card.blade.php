...
<div class="flex justify-between border-b py-5">
    ...
    <div class="flex gap-2">
        <div title="Edit" class="py-2 pl-2 pr-1 flex justify-center items-center border rounded-md shadow-md bg-blue-500 hover:bg-blue-600 active:scale-95 h-8 aspect-square fill-white cursor-pointer relative">
            <svg
                class="w-4"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 576 512">
        ...
        @if ($address->id != Auth::user()->mainAddress->id)
            ...
            <form action="/user/address/{{ $address->id }}}" method="POST">
                ...
                @method('DELETE')
                <button>
                    <div title="Delete" class="py-2 pl-2 pr-1 flex justify-center items-center border rounded-md shadow-md bg-red-500 hover:bg-red-600 active:scale-95 h-8 aspect-square fill-white cursor-pointer relative">
                        <svg
                            class="w-4"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 576 512">
