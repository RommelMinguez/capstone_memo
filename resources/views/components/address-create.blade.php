...
<div id="address-create-form" class="fixed hidden inset-0 h-screen w-screen bg-opacity-60 bg-black z-50  overflow-auto ">
    <div class="flex min-h-full justify-center items-center  py-10 ">
        <form id="create-edit-form-form" action="/user/address" method="POST" class="h-fit">

            @csrf
            {{-- @method("PUT") --}}
            <input id="address-method-inp" type="hidden" name="_method" value="PUT">

            <div class="p-5 bg-[#FEF6E4] rounded-xl border shadow-md">
                <div class="flex justify-between items-center">
                    <div id="create-header-form" class="font-bold text-xl">Add New Address</div>
                ...
                <div id="form-loading" class="p-20">
                    <x-loading></x-loading>
                </div>
                ...
                <div id="form-content" class="hidden">
                    ...
                    <div class="flex justify-end">
                        <button class="py-2 px-5 text-white font-semibold border rounded-md bg-red-500 shadow-sm hover:bg-red-600 active:scale-95">Save</button>
                    </div>
                </div>
            </div>
        </form>
