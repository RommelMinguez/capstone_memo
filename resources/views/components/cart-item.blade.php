<tr class="border-y-2 " id="row">
    <td class="text-center">
        <input type="checkbox" id="cb" class="w-8 h-8 text-[#F44336] cursor-pointer">
    </td>
    <td class="p-5 m-auto">
    ...
    <td class="text-center">
        <button class="bg-red-500 w-10 h-10 rounded-md shadow-md font-bold text-white text-3xl m-0 p-0 overflow-hidden">
            <svg
