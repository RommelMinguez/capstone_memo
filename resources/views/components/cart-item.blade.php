...
<tr class="border-y-2 cart-row">
    <td class="text-center">
        <input checked title="Select Item" name="selected-cake[]" form="form-order" type="checkbox" value="{{ $item->id }}" class="w-8 h-8 text-[#F44336] cursor-pointer cart-check-box">
    </td>
    <td class="p-5 m-auto">
    ...
    <td class="px-5">
        <ol>
            <li class="font-semibold text-xl">{{ $item->cake->name }}</li><br><br>
            <li>Age: {{ $item->age }}</li>
