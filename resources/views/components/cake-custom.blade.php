...
<div id="customCake_form" class="hidden fixed inset-0 bg-black bg-opacity-50 w-screen h-screen z-50 overflow-auto">
    <div class="w-full h-full flex justify-center py-10 overflow-auto">
        <div class="border shadow-md p-5 w-[900px] h-fit rounded-md bg-[#FFEFF5]">
            ...
            <div id="cakeForm" class="">
                ...
                <form action="/user/custom" method="POST" enctype="multipart/form-data">
