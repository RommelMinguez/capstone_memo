...
class MessagesController extends Controller
{
    ...
    public function updateStatus(Request $request)
    {
        ...
        // Update user status in database if you have a status column
        // Or use cache
        Cache::put('user-status-' . $user->id, $status, now()->addMinutes(5));
    ...
    public function typing(Request $request)
    {
        ...
        broadcast(new UserTyping($user->id, $recipientId, $isTyping))->toOthers();
    ...
    public function sendMessage(Request $request)
{
    ...
    // Broadcast the message to others listening on the receiver's channel
